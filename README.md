...
| ------------ | ------------------------------------------------------------------- |
| `funds`      | name, amount                                                        |
| `placements` | name, amount (USDT), kind (wallet/exchange), address (для wallet), exchange (KuCoin/Bitget, для exchange), exchange_account (spot/main), comment, trx_amount (баланс нативного TRX, справочно) |
