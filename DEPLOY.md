...
это перенесёт всё депо (средства, свободные средства, долги) как есть:
...
свободных средств из сети/с бирж (как кнопка «Проверить балансы») и сохраняет суммарный TRX
